...
- Release version 0.8.1 with the compact dashboard and consistent quota bars. ([PR #28](https://github.com/TheBeems/CodexUsageDock/pull/28))
...
- Release version 0.8.0 with matching version information in the details page. ([PR #27](https://github.com/TheBeems/CodexUsageDock/pull/27))
